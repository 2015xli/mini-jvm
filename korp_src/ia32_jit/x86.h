...
enum korp_muldiv_kind{
    op_mul, op_imul, op_div, op_idiv
};

enum korp_ia32_prefix{
    es_prefix = 0x26,
    cs_prefix = 0x2E,
    ss_prefix = 0x36,
    ds_prefix = 0x3E,
...
uint8* widen_to_full(uint8* buf, korp_ia32_reg, uint32, int32 is_signed, korp_ia32_mode);
uint8* widen_to_half(uint8* buf, korp_ia32_reg, uint32, int32 is_signed, korp_ia32_mode);
